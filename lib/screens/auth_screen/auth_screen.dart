...
import 'package:bir_qadam_pos/models/pos_desk/pos_desk_model.dart';
import 'package:bir_qadam_pos/models/werehouse/werehouse_model.dart';
...
class _AuthentificationScreenState extends State<AuthentificationScreen> {
  ...
  BranchModel mainSelectedBranch = BranchModel();
  WerehouseModel mainSelectedWerehouse = WerehouseModel();
  PosDeskModel mainSelectedPosDesktop = PosDeskModel();
                            ...
                            child: BlocConsumer<PosDeskBloc, PosDeskState>(
                              listener: (context, state) {
                                if (state is PosDeskSucces) {
                                  ...
                                  heightPoslPopUp = posdesk.isEmpty
                                      ? 55.w
                                      : posdesk.length * 55.w;
                                }
                              },
                              builder: (context, state) {
                                return PopupMenuButton(
                                    constraints: BoxConstraints.expand(
                                        height: heightPoslPopUp, width: 400),
                                    offset: keyboardVisible
                                        ? const Offset(90, 250)
                                        : const Offset(90, 50),
                                    onOpened: () {
                                    ...
                                    onSelected: (value) {
                                      ...
                                      mainSelectedPosDesktop = value;
                                      AppPrefs.setPosDesk(value.id!);
                                      setState(() {});
                                    },
                                    itemBuilder: (_) {
                                      ...
                                      return ColseShiftScreen(
                                        ...
                                        posdesk:
                                            mainposDesktop == 'Kassani tanlang'
                                                ? []
                                                : [mainSelectedPosDesktop],
                                        wereHouse:
                                            mainWerehouse == 'Omborni tanlang'
                                                ? []
                                                : [mainSelectedWerehouse],
                                      );
                                    },
                                  ));
                                },
